          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 max-w-3xl text-xs leading-5 text-muted-foreground">
                Редактируй диагностики, оплаты и сумму прямо в дневных строках. Если ручной факт задан, он заменяет CRM-значение за этот день и сразу попадает в сквозную аналитику, рекламный кабинет и дашборд.
              </p>
            </div>
          </div>
          <div className={cn(
