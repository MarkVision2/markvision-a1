...
import { Camera, Edit2, Eye, Globe, Globe2, GitBranch, Link2, MessageCircle, Phone, Plus, Search, Trash2, UserCircle2, Users2, XCircle } from "lucide-react";
...
import { ProjectWebsitesSettings } from "@/components/settings/ProjectWebsitesSettings";
    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6">
      ...
      <Tabs defaultValue="team" className="w-full">
        <TabsList className="mb-5 flex h-auto w-full flex-wrap justify-start gap-1 bg-card/40 p-1">
          ...
          <TabsTrigger value="domains" className="gap-2"><Globe2 className="h-3.5 w-3.5" /> Домены</TabsTrigger>
