...
const newWay = [
  ...
  "Баннеры и креативы создаются сами",
...
const webinarShow = [
  ...
  { icon: Sparkles, text: "Как создаются креативы и баннеры под разные офферы" },
...
const afterCourse = [
  ...
  { bold: "Продавать настройку таких систем", rest: " клиентам как отдельную услугу" },
...
const faq = [
  ...
  },
  {
    ...
    a: "Нет. Мы собираем целую систему, которая берёт маркетинг на себя: сайты, CRM, аналитику, отчёты, контент. ChatGPT лишь один из инструментов внутри этой системы.",
  },
  {
          ...
          <div className="grid items-start gap-10 lg:grid-cols-[380px_1fr] lg:gap-16">
            ...
            <Reveal delay={120}>
              ...
              <div className="mt-6 space-y-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
                ...
                <p>
                  Когда клиентов стало больше, я упёрся в потолок: расти дальше было физически невозможно.
      ...
      <section className="border-t border-border/60">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
          <Reveal className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Чтобы не начинать с нуля: берёшь готовое, настраиваешь под клиента, запускаешь.
            </p>
          </Reveal>
