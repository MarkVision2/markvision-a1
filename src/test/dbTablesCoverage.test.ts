 ...
 *
 * Долг закрыт миграцией 20260829170000: схемы сняты с прод-базы и заведены в репозиторий.
 * Список должен оставаться пустым — новая таблица без миграции роняет этот тест.
 */
const CREATED_OUTSIDE_REPO: string[] = [];
