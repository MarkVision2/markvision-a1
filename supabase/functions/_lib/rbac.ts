...
export const ACTION_LEVELS: Record<string, PermissionLevel> = {
  ...
  routine_list: "read", tasks_list: "read", calendar: "read", analytics_insights: "read", replication_list: "read",
  ...
  jobs_approve: "publish", jobs_reject: "publish", winner_replicate: "publish",
